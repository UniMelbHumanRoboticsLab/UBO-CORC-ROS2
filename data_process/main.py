...
from post_process_pkg import lpf,calc_fixed_diff,calc_mag,segment_sbmvmts,rescale,separate_train_test,separate_train_val,create_dir
...
for var in session_data["variants"]:
    ...
    for rep in range(1,session_data["num_rep"]+1):
        ...
        # TODO:use xsens data to add the initial installation bias, remove the gravity component and the average bias collected during Take_bias from corc_data to compensate
